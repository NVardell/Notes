...
basePackages="yarn create-react-app npm-check-updates"
...
alias ui="ncu -i -u --color --packageFile package.json"  # Update/Upgrade Interactive
...
# alias noid="noig $basePackages"    # Install Default Packages
