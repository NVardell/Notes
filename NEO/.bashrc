# NV@NEO MINGW64 /
# $ alias CDL='cd ~/Desktop/$(date '+%Y%m%d')'

# NV@NEO MINGW64 /
# $ CDL
# bash: cd: /c/Users/NV/Desktop/20221104: No such file or directory

##  NV@NEO MINGW64 /n/HUGE
...
## New Laziness
##
alias hg="history | grep -in "  # History Grep
alias gh="hg"
alias pft="file --mime-type ./*"    # Print File Types
...
alias gpp="pp | grep -i"                                   # Grep Print Path
...
baseNodePackages="yarn npm-check npm-check-updates create-react-app"
alias npmib="noig $baseNodePackages"    # Install Default Packages
...
alias cf="cmf; ctf; czf; cef; ced;" # Short ~ All Find Counters
...
alias exiftool="pathToExifTool"
alias dxt="exiftool -*Size -*Extension -*Created -Meg* -Model -*V*Rate -*Comment"
alias fft="exiftool -*Extension"
alias ff="find . -type f -exec file -- {} +"
alias ffc="find . -type f -exec file -- {} + | clip"
toExifTool="/i/Repo/Note/Programs/GitBash/bin/exiftool -csv"
toExifToolAll="/i/Repo/Note/Programs/GitBash/bin/exiftool -a -csv"
toExifToolWithMods="/i/Repo/Note/Programs/GitBash/bin/exiftool -*Size -*Extension -csv"
alias ffet="find . -type f -exec $toExifTool {} + | clip"
alias ffeta="find . -type f -exec $toExifToolAll {} +"
alias ffetac="find . -type f -exec $toExifToolAll {} + | clip"
alias ffetm="find . -type f -exec $toExifToolWithMods {} + | clip"
...
alias lds="du -c -Sk ./* | sort -hr" # List Directories - Simple
alias ld="sl; du -c -Sk -d2 -t2M ./* | sort -hr"                                                        # List Directories & Sort by Size ()
