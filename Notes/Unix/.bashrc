...
alias cwd="find . -type d \( -name "*.idea" -o -name "node_*" -o -name "target" \) "                      # Clean What Directories
alias cpfd="cwf -prune -exec rm -r {} +; cwd -prune -exec rm -r {} +"                                     # Clean Project Files & Directories
...
# MISC - Migrate Home (Forces Gitbash to start in Home DIR - Not ideal when you want to use 'Open Bash Here' in file explorer.)
# cd ~