...
##  
        ...
        + So, we need to get into the directories but not change their names.
            - Let’s imagine that we need to process five files: 
                    ...
                    5.    \--- 'another_image'
            - We want to rename only the 'image' and 'another_image' files, 
            ...
            - To check the actual type of the file, we’ll use the file command,
                + Ex.      
                    ...
                    inode/directory
        + Finally, we’ll use a while loop with a conditional statement to iterate over the files.
            + Ex.
...
5. Summary
In this tutorial, we learned how to use Bash to precisely add extensions to the extensionless files. We considered various possible pitfalls like files already having the extension, files of the wrong type, or nested directories.
